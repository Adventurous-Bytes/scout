...
CREATE POLICY "Artifact access: Device API keys and users with view role" ON "public"."artifacts" FOR SELECT USING ((("device_id" = "private"."key_uid"()) OR "private"."has_good_view_role"(( SELECT "auth"."uid"() AS "uid"), ( SELECT "private"."get_herd_id_by_device_id"("artifacts"."device_id") AS "get_herd_id_by_device_id"))));



CREATE POLICY "Artifact creation: Device API keys and users with edit role" ON "public"."artifacts" FOR INSERT WITH CHECK ((("device_id" = "private"."key_uid"()) OR "private"."has_good_edit_role"(( SELECT "auth"."uid"() AS "uid"), ( SELECT "private"."get_herd_id_by_device_id"("artifacts"."device_id") AS "get_herd_id_by_device_id"))));



CREATE POLICY "Artifact deletion: Device API keys and users with edit role" ON "public"."artifacts" FOR DELETE USING ((("device_id" = "private"."key_uid"()) OR "private"."has_good_edit_role"(( SELECT "auth"."uid"() AS "uid"), ( SELECT "private"."get_herd_id_by_device_id"("artifacts"."device_id") AS "get_herd_id_by_device_id"))));



CREATE POLICY "Artifact modification: Device API keys and users with edit role" ON "public"."artifacts" FOR UPDATE USING ((("device_id" = "private"."key_uid"()) OR "private"."has_good_edit_role"(( SELECT "auth"."uid"() AS "uid"), ( SELECT "private"."get_herd_id_by_device_id"("artifacts"."device_id") AS "get_herd_id_by_device_id"))));
...
CREATE POLICY "Connectivity access: Device API keys and users with view role" ON "public"."connectivity" FOR SELECT USING (((("device_id" IS NULL) AND ("session_id" IS NOT NULL) AND ("session_id" IN ( SELECT "sessions"."id"
  ...
  WHERE ("sessions"."device_id" = "private"."key_uid"())))) OR (("session_id" IS NULL) AND ("device_id" IS NOT NULL) AND ("device_id" = "private"."key_uid"())) OR (("session_id" IS NOT NULL) AND ("device_id" IS NOT NULL) AND ("device_id" = "private"."key_uid"()) AND ("session_id" IN ( SELECT "sessions"."id"
   FROM "public"."sessions"
  WHERE ("sessions"."device_id" = "private"."key_uid"())))) OR (("device_id" IS NOT NULL) AND ("device_id" <> "private"."key_uid"()) AND ("private"."key_uid"() <> 0) AND "private"."is_radio_mesh_gateway"("private"."key_uid"()) AND "private"."herd_has_device"("private"."get_herd_id_by_device_id"("private"."key_uid"()), "device_id")) OR "private"."has_good_view_role"(( SELECT "auth"."uid"() AS "uid"),
CASE
...
4. Radio mesh base station gateways to read connectivity records for other devices in the same herd (enables upserts)
...
CREATE POLICY "Connectivity creation: Device API keys and users with edit role" ON "public"."connectivity" FOR INSERT WITH CHECK (((("device_id" IS NULL) AND ("session_id" IS NOT NULL) AND ("session_id" IN ( SELECT "sessions"."id"
  ...
  WHERE ("sessions"."device_id" = "private"."key_uid"())))) OR (("session_id" IS NULL) AND ("device_id" IS NOT NULL) AND ("device_id" = "private"."key_uid"())) OR (("session_id" IS NOT NULL) AND ("device_id" IS NOT NULL) AND ("device_id" = "private"."key_uid"()) AND ("session_id" IN ( SELECT "sessions"."id"
   FROM "public"."sessions"
  WHERE ("sessions"."device_id" = "private"."key_uid"())))) OR (("device_id" IS NOT NULL) AND ("device_id" <> "private"."key_uid"()) AND ("private"."key_uid"() <> 0) AND "private"."is_radio_mesh_gateway"("private"."key_uid"()) AND "private"."herd_has_device"("private"."get_herd_id_by_device_id"("private"."key_uid"()), "device_id")) OR "private"."has_good_edit_role"(( SELECT "auth"."uid"() AS "uid"),
CASE
    WHEN ("device_id" IS NOT NULL) THEN "private"."get_herd_id_by_device_id"("device_id")
    WHEN ("session_id" IS NOT NULL) THEN "private"."get_herd_id_by_device_id"(( SELECT "sessions"."device_id"
       FROM "public"."sessions"
...
4. Radio mesh base station gateways to create connectivity records for other devices in the same herd
...
4. Radio mesh base station gateways to update connectivity records for other devices in the same herd
...
CREATE POLICY "Event creation: Device API keys and users with edit role" ON "public"."events" FOR INSERT WITH CHECK ((("device_id" = "private"."key_uid"()) OR "private"."has_good_edit_role"(( SELECT "auth"."uid"() AS "uid"), ( SELECT "private"."get_herd_id_by_device_id"("events"."device_id") AS "get_herd_id_by_device_id"))));
...
CREATE POLICY "Event modification: Device API keys and users with edit role" ON "public"."events" FOR UPDATE USING ((("device_id" = "private"."key_uid"()) OR "private"."has_good_edit_role"(( SELECT "auth"."uid"() AS "uid"), ( SELECT "private"."get_herd_id_by_device_id"("events"."device_id") AS "get_herd_id_by_device_id"))));
...
CREATE POLICY "Session creation: Device API keys and users with edit role" ON "public"."sessions" FOR INSERT WITH CHECK ((("device_id" = "private"."key_uid"()) OR "private"."has_good_edit_role"(( SELECT "auth"."uid"() AS "uid"), ( SELECT "private"."get_herd_id_by_device_id"("sessions"."device_id") AS "get_herd_id_by_device_id"))));
...
CREATE POLICY "Session modification: Device API keys and users with edit role" ON "public"."sessions" FOR UPDATE USING ((("device_id" = "private"."key_uid"()) OR "private"."has_good_edit_role"(( SELECT "auth"."uid"() AS "uid"), ( SELECT "private"."get_herd_id_by_device_id"("sessions"."device_id") AS "get_herd_id_by_device_id"))));
