...
CREATE OR REPLACE FUNCTION "private"."enforce_broken_versions_software"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "private"."has_view_role_any_herd"("user_id_caller" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'extensions'
    AS $$
begin
...
CREATE SEQUENCE IF NOT EXISTS "public"."health_metrics_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE INDEX "idx_health_metrics_lookup" ON "public"."health_metrics" USING "btree" ("device_id", "metric_name", "timestamp" DESC);
...
CREATE OR REPLACE TRIGGER "enforce_broken_versions_software_trigger" BEFORE INSERT OR UPDATE ON "public"."versions_software" FOR EACH ROW EXECUTE FUNCTION "private"."enforce_broken_versions_software"();
...
ALTER TABLE ONLY "public"."health_metrics"
    ADD CONSTRAINT "health_metrics_device_id_fkey" FOREIGN KEY ("device_id") REFERENCES "public"."devices"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY "Health metrics access: Device API keys and users with view role" ON "public"."health_metrics" FOR SELECT USING ((("device_id" = "private"."key_uid"()) OR (("private"."key_uid"() <> 0) AND "private"."is_approved_gateway_device_type"("private"."key_uid"()) AND "private"."herd_has_device"("private"."get_herd_id_by_device_id"("private"."key_uid"()), "device_id")) OR "private"."has_good_view_role"(( SELECT "auth"."uid"() AS "uid"), ( SELECT "private"."get_herd_id_by_device_id"("health_metrics"."device_id") AS "get_herd_id_by_device_id"))));



CREATE POLICY "Health metrics creation: Device API keys and users with edit ro" ON "public"."health_metrics" FOR INSERT WITH CHECK ((("device_id" = "private"."key_uid"()) OR (("private"."key_uid"() <> 0) AND "private"."is_approved_gateway_device_type"("private"."key_uid"()) AND "private"."herd_has_device"("private"."get_herd_id_by_device_id"("private"."key_uid"()), "device_id")) OR "private"."has_good_edit_role"(( SELECT "auth"."uid"() AS "uid"), ( SELECT "private"."get_herd_id_by_device_id"("health_metrics"."device_id") AS "get_herd_id_by_device_id"))));



CREATE POLICY "Health metrics deletion: Device API keys and users with edit ro" ON "public"."health_metrics" FOR DELETE USING ((("device_id" = "private"."key_uid"()) OR (("private"."key_uid"() <> 0) AND "private"."is_approved_gateway_device_type"("private"."key_uid"()) AND "private"."herd_has_device"("private"."get_herd_id_by_device_id"("private"."key_uid"()), "device_id")) OR "private"."has_good_edit_role"(( SELECT "auth"."uid"() AS "uid"), ( SELECT "private"."get_herd_id_by_device_id"("health_metrics"."device_id") AS "get_herd_id_by_device_id"))));



CREATE POLICY "Health metrics modification: Device API keys and users with edi" ON "public"."health_metrics" FOR UPDATE USING ((("device_id" = "private"."key_uid"()) OR (("private"."key_uid"() <> 0) AND "private"."is_approved_gateway_device_type"("private"."key_uid"()) AND "private"."herd_has_device"("private"."get_herd_id_by_device_id"("private"."key_uid"()), "device_id")) OR "private"."has_good_edit_role"(( SELECT "auth"."uid"() AS "uid"), ( SELECT "private"."get_herd_id_by_device_id"("health_metrics"."device_id") AS "get_herd_id_by_device_id"))));
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."health_metrics" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."health_metrics" TO "authenticated";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."health_metrics" TO "service_role";



GRANT ALL ON SEQUENCE "public"."health_metrics_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."health_metrics_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."health_metrics_id_seq" TO "service_role";
