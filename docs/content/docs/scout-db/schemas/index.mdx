...
erDiagram
    ...
    devices ||--o{ health_metrics : reports
    ...
    certificates ||--o{ parts : validates
```
...
- **Devices** generate **Sessions**, **Events**, **Connectivity**, and **Health metrics** data
- **Events** can contain **Tags** for object detection results
- **Zones** trigger automated **Actions** for spatial monitoring
- **Parts** are validated by **Certificates** for device compliance
